...
function Contact() {
  return (
    <div>
      ...
      <div class="font-[sans-serif] max-w-6xl mx-auto relative bg-white rounded-lg py-6  mt-10  ">
      <Link to="/" className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 bg-black ">✕</Link>

      <div class="grid lg:grid-cols-3 items-center px-10  ">
        <div class="grid grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
          <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            ...
            <p class="text-xs text-gray-600 mt-1"> 123 Main Street, City, Country</p>
          </div>
          <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
        ...
        <div class="lg:col-span-2 bg-gradient-to-r from-purple-500 via-purple-600 to-purple-800 rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
          <h2 class="text-2xl sm:text-3xl text-white text-center font-bold mb-6">Contact us</h2>
          <form>
            <div class="max-w-md mx-auto space-y-2">
              ...
              <textarea placeholder='Message' rows="6"
                class="w-full bg-white rounded-md px-4 text-sm pt-3 outline-none"></textarea>
